        ...
        \begin{subparts}
            \subpart{
                \begin{itemize}
                    ...
                    \item Disvantage: Dot product attention can only learn a \textbf{hard} (or \textbf{fixed}) alignment between the source and target words because it lacks a learnable weight matrix $\bW$. In other words, Multiplicative attention can learn more complex attention distributions than dot product attention due to the additional learnable weight matrix. 
                \end{itemize}
            }
            \subpart{
                \begin{itemize}
                    \item Advantage: Additive attention can learn \textbf{more complex} and \textbf{higher abstract} attention distributions than multiplicative attention because it has a additional feed-forward neural network layer, which introduce non-linearity to the attention distribution.
                    \item Disvantage: Additive attention is \textbf{slower} to compute than multiplicative attention because it requires additional layer of computation. And it may suffer from the \textbf{valishing gradient} problem because of the activation function $\text{tanh}$.
                \end{itemize}
            }
            \end{subparts}
    }
